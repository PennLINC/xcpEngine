...
option_list = list(
   ...
   make_option(c("-b", "--bolus"), action="store", default=0.7, type='numeric',
              help="bolus duration in s
                  [default 0.7]."),
   make_option(c("-r", "--tinverse"), action="store", default=1.8, type='numeric',
              help="The inversion time in ms
                  [default 1.8]."),
...
cbf                     <- (6000 * lambda /
                           (2 * alpha * m0scale * ti1*exp(-ti / t1b)))
